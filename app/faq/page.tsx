...
const faqGroups: {title: string; items: SeoFaq[]}[] = [
  ...
  {title: 'מחיר, תמונות ותהליך', items: [
    ...
    {question: 'מתי מקבלים את החולצות?', answer: 'לאחר אישור העיצוב, ההזמנה והתשלום, מתאמים משלוח לפי הכתובת, הכמות והזמינות. זמן המשלוח המוצהר הוא עד 3 ימי עסקים לאחר האישור, לא כולל זמן עיצוב ותיקונים.'},
