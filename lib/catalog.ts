export const EXTRA_SHIRT_PRICE = 99;
export const CUSTOM_PRICES: Record<number, number> = {5:549,10:990,15:1390,20:1790};
export const packs=[
...
{name:'הכלה והחברות',tag:'BRIDE SQUAD',n:6,price:649,desc:'שש חברות. עיר אחת. ערב שלכן.',icon:'♡',cls:'pink',image:'/bride-shared-v2.webp'},
{name:'החתן והחבר׳ה',tag:'THE WOLF PACK',n:6,price:649,desc:'הקאסט שלכם. המסיבה שלכם.',icon:'✦',cls:'blue',image:'/groom-shared-v2.webp'},
{name:'צוות עם אופי',tag:'TEAM SPIRIT',n:10,price:990,desc:'מעצבים את האנשים שמאחורי הצוות.',icon:'↗',cls:'green',image:'/tech-team.webp'},
{name:'הרעיון שלכם',tag:'YOUR OWN THING',n:5,price:549,desc:'כל רעיון, כל אירוע. עיצוב שנולד מכם.',icon:'✺',cls:'custom',image:'/shirts.webp'}
];
