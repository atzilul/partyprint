...
export async function notifyOrder(env:MailEnv,order:Order,bundleUrl:string,attempt='initial'){
 ...
 const bundleDays=bundleLinkDays();
 const text=summary+'\n\nהמשך טיפול בוואטסאפ: '+wa+'\nהורדת פרטי ההזמנה והתמונות (קישור ל־'+bundleDays+' ימים): '+bundleUrl+'\nניהול ההזמנה: '+admin;
